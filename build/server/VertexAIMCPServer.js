...
export class VertexAIMCPServer {
    ...
    constructor(config) {
        ...
        // Initialize handlers
        this.queryHandler = new QueryHandler(this.conversationManager, this.agenticLoop, config.enableConversations, logDir, disableLogging);
    ...
    setupHandlers() {
        ...
        this.server.setRequestHandler(ListToolsRequestSchema, async () => {
            const tools = [
                ...
                {
                    name: "search",
                    description: "Search for information using Vertex AI. Returns a list of relevant search results. " +
